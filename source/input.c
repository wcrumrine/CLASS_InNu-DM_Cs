...
int input_read_parameters(
  ...
  class_call(parser_read_double(pfc,"omega_nudm",&param2,&flag2,errmsg),
             errmsg,
             errmsg);
  class_call(parser_read_double(pfc,"f_nudm",&param3,&flag3,errmsg),
             errmsg,
             errmsg);
  class_test(((flag1 == _TRUE_) && (flag2 == _TRUE_)) || ((flag1 == _TRUE_) && (flag3 == _TRUE_)) || ((flag2 == _TRUE_) && (flag3 == _TRUE_)),
             errmsg,
             "In input file, you can only enter one of Omega_nudm, omega_nudm, or f_nudm, choose one");
  ...
  if (flag3 == _TRUE_) {
    class_test((param3 < 0.) || (param3 > 1.),
                errmsg,
                "The fraction of CDM must be between 0 and 1. You asked for f_nudm=%e",param3);
    class_test((param3 > 0.) && (pba->Omega0_cdm == 0.),
                errmsg,
                "If you want a fraction of CDM, you should not set the fraction of CDM to zero.");
    pba->Omega0_nudm = param3 * pba->Omega0_cdm;
    /* readjust Omega0_cdm and Omega_tot*/
    pba->Omega0_cdm -= pba->Omega0_nudm;
